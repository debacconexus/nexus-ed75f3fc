...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "FleetOps Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Fleet Asset Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "fleet_asset_record_records";
'use strict';
